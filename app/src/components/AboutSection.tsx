			...
			<div className="group p-[3px] rounded-2xl bg-gradient-to-r from-[#0b1f3a] via-[#174a8c] to-[#6b5b95]">
				<div className="h-full bg-white rounded-[calc(1rem-3px)] border-4 border-black p-5 md:p-7">
					...
					<div className="space-y-3 text-[#0b1f3a]">
						<p>
							We are building a platform where domain experts, signal-finders, and
							scouts share insights and place wagers on the success of early-stage
							startups. Sponsors use these markets to discover high-signal
							opportunities and to reward accurate research. The design is inspired by{' '}
							{''}
							<a
						...
						<ol className="list-decimal pl-6 space-y-1">
							<li>
								Sponsors open markets like “Will we fund startup X within the next 6
								months?”, seed initial liquidity (typically in NO), and define
								resolution criteria.
							</li>
							<li>
						...
						<ul className="list-disc pl-6 space-y-1">
							...
							<li>
								Challenge — Sponsor integrity: v0 assumes reputable sponsors with
								restricted actions.
							</li>
						</ul>
						<div>
