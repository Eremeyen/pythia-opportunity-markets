...
export const SWITCH_TO_PRIVATE_DISCRIMINATOR = new Uint8Array([66, 215, 34, 190, 67, 228, 88, 184]);

export function getSwitchToPrivateDiscriminatorBytes() {
	return fixEncoderSize(getBytesEncoder(), 8).encode(SWITCH_TO_PRIVATE_DISCRIMINATOR);
}

export type SwitchToPrivateInstruction<
...
export type SwitchToPrivateInstructionData = {
	discriminator: ReadonlyUint8Array;
	computationOffset: bigint;
	mxeNonce: bigint;
};

export type SwitchToPrivateInstructionDataArgs = {
	computationOffset: number | bigint;
	mxeNonce: number | bigint;
};

export function getSwitchToPrivateInstructionDataEncoder(): FixedSizeEncoder<SwitchToPrivateInstructionDataArgs> {
	return transformEncoder(
		...
		(value) => ({ ...value, discriminator: SWITCH_TO_PRIVATE_DISCRIMINATOR }),
	);
}

export function getSwitchToPrivateInstructionDataDecoder(): FixedSizeDecoder<SwitchToPrivateInstructionData> {
...
export function getSwitchToPrivateInstructionDataCodec(): FixedSizeCodec<
	SwitchToPrivateInstructionDataArgs,
	SwitchToPrivateInstructionData
> {
	return combineCodec(
		getSwitchToPrivateInstructionDataEncoder(),
		getSwitchToPrivateInstructionDataDecoder(),
	);
}

export type SwitchToPrivateAsyncInput<
...
> = {
	...
	computationOffset: SwitchToPrivateInstructionDataArgs['computationOffset'];
	mxeNonce: SwitchToPrivateInstructionDataArgs['mxeNonce'];
};

export async function getSwitchToPrivateInstructionAsync<
	TAccountPayer extends string,
...
>(
	input: SwitchToPrivateAsyncInput<
		TAccountPayer,
		TAccountMarket,
		TAccountSignPdaAccount,
		TAccountMxeAccount,
...
export function getSwitchToPrivateInstruction<
	TAccountPayer extends string,
	TAccountMarket extends string,
	TAccountSignPdaAccount extends string,
	TAccountMxeAccount extends string,
...
export type ParsedSwitchToPrivateInstruction<
	TProgram extends string = typeof PYTHIA_OP_PROGRAM_ADDRESS,
...
> = {
	...
	data: SwitchToPrivateInstructionData;
};

export function parseSwitchToPrivateInstruction<
...
>(
	instruction: Instruction<TProgram> &
		...
		InstructionWithData<ReadonlyUint8Array>,
): ParsedSwitchToPrivateInstruction<TProgram, TAccountMetas> {
	...
	return {
		...
		data: getSwitchToPrivateInstructionDataDecoder().decode(instruction.data),
	};
}
