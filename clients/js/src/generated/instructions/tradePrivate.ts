...
export const TRADE_PRIVATE_DISCRIMINATOR = new Uint8Array([129, 42, 123, 125, 123, 3, 247, 13]);

export function getTradePrivateDiscriminatorBytes() {
	return fixEncoderSize(getBytesEncoder(), 8).encode(TRADE_PRIVATE_DISCRIMINATOR);
}

export type TradePrivateInstruction<
...
export type TradePrivateInstructionData = {
...
export type TradePrivateInstructionDataArgs = {
...
export function getTradePrivateInstructionDataEncoder(): FixedSizeEncoder<TradePrivateInstructionDataArgs> {
	return transformEncoder(
		...
		(value) => ({ ...value, discriminator: TRADE_PRIVATE_DISCRIMINATOR }),
	);
}

export function getTradePrivateInstructionDataDecoder(): FixedSizeDecoder<TradePrivateInstructionData> {
...
export function getTradePrivateInstructionDataCodec(): FixedSizeCodec<
	TradePrivateInstructionDataArgs,
	TradePrivateInstructionData
> {
	return combineCodec(
		getTradePrivateInstructionDataEncoder(),
		getTradePrivateInstructionDataDecoder(),
	);
}

export type TradePrivateAsyncInput<
...
> = {
	...
	computationOffset: TradePrivateInstructionDataArgs['computationOffset'];
	tradeCiphertext: TradePrivateInstructionDataArgs['tradeCiphertext'];
	tradePubKey: TradePrivateInstructionDataArgs['tradePubKey'];
	tradeNonce: TradePrivateInstructionDataArgs['tradeNonce'];
};

export async function getTradePrivateInstructionAsync<
	TAccountPayer extends string,
...
export function getTradePrivateInstruction<
	TAccountPayer extends string,
	TAccountMarket extends string,
	TAccountSignPdaAccount extends string,
	TAccountMxeAccount extends string,
...
export type ParsedTradePrivateInstruction<
	TProgram extends string = typeof PYTHIA_OP_PROGRAM_ADDRESS,
...
> = {
	...
	data: TradePrivateInstructionData;
};

export function parseTradePrivateInstruction<
...
>(
	instruction: Instruction<TProgram> &
		...
		InstructionWithData<ReadonlyUint8Array>,
): ParsedTradePrivateInstruction<TProgram, TAccountMetas> {
	...
	return {
		...
		data: getTradePrivateInstructionDataDecoder().decode(instruction.data),
	};
}
