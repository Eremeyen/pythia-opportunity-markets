...
export const INIT_MARKET_ENCRYPTED_DISCRIMINATOR = new Uint8Array([
	37, 235, 227, 196, 198, 232, 201, 57,
]);

export function getInitMarketEncryptedDiscriminatorBytes() {
	return fixEncoderSize(getBytesEncoder(), 8).encode(INIT_MARKET_ENCRYPTED_DISCRIMINATOR);
}

export type InitMarketEncryptedInstruction<
...
export type InitMarketEncryptedInstructionData = {
...
export type InitMarketEncryptedInstructionDataArgs = {
	computationOffset: number | bigint;
	initialLiquidityUsdc: number | bigint;
	mxeNonce: number | bigint;
};

export function getInitMarketEncryptedInstructionDataEncoder(): FixedSizeEncoder<InitMarketEncryptedInstructionDataArgs> {
	return transformEncoder(
		...
		(value) => ({
			...value,
			discriminator: INIT_MARKET_ENCRYPTED_DISCRIMINATOR,
		}),
	);
}

export function getInitMarketEncryptedInstructionDataDecoder(): FixedSizeDecoder<InitMarketEncryptedInstructionData> {
...
export function getInitMarketEncryptedInstructionDataCodec(): FixedSizeCodec<
	InitMarketEncryptedInstructionDataArgs,
	InitMarketEncryptedInstructionData
> {
	return combineCodec(
		getInitMarketEncryptedInstructionDataEncoder(),
		getInitMarketEncryptedInstructionDataDecoder(),
	);
}

export type InitMarketEncryptedAsyncInput<
...
> = {
	...
	computationOffset: InitMarketEncryptedInstructionDataArgs['computationOffset'];
	initialLiquidityUsdc: InitMarketEncryptedInstructionDataArgs['initialLiquidityUsdc'];
	mxeNonce: InitMarketEncryptedInstructionDataArgs['mxeNonce'];
};

export async function getInitMarketEncryptedInstructionAsync<
	TAccountPayer extends string,
...
>(
	input: InitMarketEncryptedAsyncInput<
		TAccountPayer,
		TAccountMarket,
		TAccountSignPdaAccount,
		TAccountMxeAccount,
	...
	InitMarketEncryptedInstruction<
		TProgramAddress,
		TAccountPayer,
		TAccountMarket,
		TAccountSignPdaAccount,
...
> {
	...
	return Object.freeze({
		...
		data: getInitMarketEncryptedInstructionDataEncoder().encode(
			args as InitMarketEncryptedInstructionDataArgs,
		),
		programAddress,
	} as InitMarketEncryptedInstruction<TProgramAddress, TAccountPayer, TAccountMarket, TAccountSignPdaAccount, TAccountMxeAccount, TAccountMempoolAccount, TAccountExecutingPool, TAccountComputationAccount, TAccountCompDefAccount, TAccountClusterAccount, TAccountPoolAccount, TAccountClockAccount, TAccountSystemProgram, TAccountArciumProgram>);
}

export type InitMarketEncryptedInput<
	TAccountPayer extends string = string,
	TAccountMarket extends string = string,
	TAccountSignPdaAccount extends string = string,
	TAccountMxeAccount extends string = string,
...
export function getInitMarketEncryptedInstruction<
	TAccountPayer extends string,
	TAccountMarket extends string,
	TAccountSignPdaAccount extends string,
	TAccountMxeAccount extends string,
	...
	TProgramAddress extends Address = typeof PYTHIA_OP_PROGRAM_ADDRESS,
>(
	input: InitMarketEncryptedInput<
		TAccountPayer,
		TAccountMarket,
		TAccountSignPdaAccount,
		TAccountMxeAccount,
...
export type ParsedInitMarketEncryptedInstruction<
	TProgram extends string = typeof PYTHIA_OP_PROGRAM_ADDRESS,
...
> = {
	...
	data: InitMarketEncryptedInstructionData;
};

export function parseInitMarketEncryptedInstruction<
...
>(
	instruction: Instruction<TProgram> &
		...
		InstructionWithData<ReadonlyUint8Array>,
): ParsedInitMarketEncryptedInstruction<TProgram, TAccountMetas> {
	...
	return {
		...
		data: getInitMarketEncryptedInstructionDataDecoder().decode(instruction.data),
	};
}
