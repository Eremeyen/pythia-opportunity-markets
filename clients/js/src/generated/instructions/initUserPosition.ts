...
export const INIT_USER_POSITION_DISCRIMINATOR = new Uint8Array([
	131, 197, 183, 39, 12, 98, 108, 68,
]);

export function getInitUserPositionDiscriminatorBytes() {
	return fixEncoderSize(getBytesEncoder(), 8).encode(INIT_USER_POSITION_DISCRIMINATOR);
}

export type InitUserPositionInstruction<
...
export type InitUserPositionInstructionData = {
	discriminator: ReadonlyUint8Array;
	computationOffset: bigint;
	mxeNonce: bigint;
};

export type InitUserPositionInstructionDataArgs = {
	computationOffset: number | bigint;
	mxeNonce: number | bigint;
};

export function getInitUserPositionInstructionDataEncoder(): FixedSizeEncoder<InitUserPositionInstructionDataArgs> {
	return transformEncoder(
		...
		(value) => ({ ...value, discriminator: INIT_USER_POSITION_DISCRIMINATOR }),
	);
}

export function getInitUserPositionInstructionDataDecoder(): FixedSizeDecoder<InitUserPositionInstructionData> {
	return getStructDecoder([
		['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
		['computationOffset', getU64Decoder()],
		['mxeNonce', getU128Decoder()],
	]);
}

export function getInitUserPositionInstructionDataCodec(): FixedSizeCodec<
	InitUserPositionInstructionDataArgs,
	InitUserPositionInstructionData
> {
	return combineCodec(
		getInitUserPositionInstructionDataEncoder(),
		getInitUserPositionInstructionDataDecoder(),
	);
}

export type InitUserPositionAsyncInput<
...
> = {
	...
	computationOffset: InitUserPositionInstructionDataArgs['computationOffset'];
	mxeNonce: InitUserPositionInstructionDataArgs['mxeNonce'];
};

export async function getInitUserPositionInstructionAsync<
	TAccountUser extends string,
...
>(
	input: InitUserPositionAsyncInput<
		TAccountUser,
		TAccountMarket,
		TAccountUserPosition,
		TAccountSignPdaAccount,
...
export function getInitUserPositionInstruction<
	TAccountUser extends string,
	TAccountMarket extends string,
	TAccountUserPosition extends string,
	TAccountSignPdaAccount extends string,
...
export type ParsedInitUserPositionInstruction<
	TProgram extends string = typeof PYTHIA_OP_PROGRAM_ADDRESS,
...
> = {
	...
	data: InitUserPositionInstructionData;
};

export function parseInitUserPositionInstruction<
...
>(
	instruction: Instruction<TProgram> &
		...
		InstructionWithData<ReadonlyUint8Array>,
): ParsedInitUserPositionInstruction<TProgram, TAccountMetas> {
	...
	return {
		...
		data: getInitUserPositionInstructionDataDecoder().decode(instruction.data),
	};
}
