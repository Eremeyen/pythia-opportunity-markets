...
export const GET_SPONSOR_VIEW_DISCRIMINATOR = new Uint8Array([225, 4, 128, 199, 133, 109, 216, 99]);

export function getGetSponsorViewDiscriminatorBytes() {
	return fixEncoderSize(getBytesEncoder(), 8).encode(GET_SPONSOR_VIEW_DISCRIMINATOR);
}

export type GetSponsorViewInstruction<
...
export type GetSponsorViewInstructionData = {
	discriminator: ReadonlyUint8Array;
	computationOffset: bigint;
	sponsorPubKey: ReadonlyUint8Array;
};

export type GetSponsorViewInstructionDataArgs = {
	computationOffset: number | bigint;
	sponsorPubKey: ReadonlyUint8Array;
};

export function getGetSponsorViewInstructionDataEncoder(): FixedSizeEncoder<GetSponsorViewInstructionDataArgs> {
	return transformEncoder(
		...
		(value) => ({ ...value, discriminator: GET_SPONSOR_VIEW_DISCRIMINATOR }),
	);
}

export function getGetSponsorViewInstructionDataDecoder(): FixedSizeDecoder<GetSponsorViewInstructionData> {
...
export function getGetSponsorViewInstructionDataCodec(): FixedSizeCodec<
	GetSponsorViewInstructionDataArgs,
	GetSponsorViewInstructionData
> {
	return combineCodec(
		getGetSponsorViewInstructionDataEncoder(),
		getGetSponsorViewInstructionDataDecoder(),
	);
}

export type GetSponsorViewAsyncInput<
...
> = {
	...
	computationOffset: GetSponsorViewInstructionDataArgs['computationOffset'];
	sponsorPubKey: GetSponsorViewInstructionDataArgs['sponsorPubKey'];
};

export async function getGetSponsorViewInstructionAsync<
	TAccountSponsor extends string,
...
>(
	input: GetSponsorViewAsyncInput<
		TAccountSponsor,
		TAccountMarket,
		TAccountSignPdaAccount,
		TAccountMxeAccount,
...
> {
	...
	return Object.freeze({
		...
		data: getGetSponsorViewInstructionDataEncoder().encode(
			args as GetSponsorViewInstructionDataArgs,
		),
		programAddress,
	} as GetSponsorViewInstruction<TProgramAddress, TAccountSponsor, TAccountMarket, TAccountSignPdaAccount, TAccountMxeAccount, TAccountMempoolAccount, TAccountExecutingPool, TAccountComputationAccount, TAccountCompDefAccount, TAccountClusterAccount, TAccountPoolAccount, TAccountClockAccount, TAccountSystemProgram, TAccountArciumProgram>);
}

export type GetSponsorViewInput<
	TAccountSponsor extends string = string,
	TAccountMarket extends string = string,
	TAccountSignPdaAccount extends string = string,
	TAccountMxeAccount extends string = string,
...
export function getGetSponsorViewInstruction<
	TAccountSponsor extends string,
	TAccountMarket extends string,
	TAccountSignPdaAccount extends string,
	TAccountMxeAccount extends string,
...
export type ParsedGetSponsorViewInstruction<
	TProgram extends string = typeof PYTHIA_OP_PROGRAM_ADDRESS,
...
> = {
	...
	data: GetSponsorViewInstructionData;
};

export function parseGetSponsorViewInstruction<
...
>(
	instruction: Instruction<TProgram> &
		...
		InstructionWithData<ReadonlyUint8Array>,
): ParsedGetSponsorViewInstruction<TProgram, TAccountMetas> {
	...
	return {
		...
		data: getGetSponsorViewInstructionDataDecoder().decode(instruction.data),
	};
}
